...
<div class="wp-clean-master-container">
    ...
    <div class="features-grid">
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/drafts.svg' ); ?>" alt="Clean Drafts">
            </div>
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/trashed-post.svg' ); ?>" alt="Clean Trashed Posts">
            </div>
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/comments.svg' ); ?>" alt="Clean Unapproved Comments">
            </div>
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/orphaned-media.svg' ); ?>" alt="Clean Orphaned Media">
            </div>
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/revisions.svg' ); ?>" alt="Clean Post Revisions">
            </div>
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/transients.svg' ); ?>" alt="Clean Transients">
            </div>
        ...
        <div class="feature">
            <div class="icon">
                <img src="<?php echo esc_url( WP_CLEAN_MASTER_URL . 'assets/icons/spam.svg' ); ?>" alt="Clean Spam Comments">
            </div>
        ...
        <table>
            ...
            <tbody>
                ...
                $logs = $wpdb->get_results( $wpdb->prepare(
                    "SELECT * FROM {$wpdb->prefix}clean_master_logs ORDER BY cleaned_on DESC LIMIT %d", 10
                ) );

                if ( ! empty( $logs ) ) {
                    foreach ( $logs as $log ) {
                        echo '<tr>
                                <td>' . esc_html( date( 'Y-m-d', strtotime( $log->cleaned_on ) ) ) . '</td>
